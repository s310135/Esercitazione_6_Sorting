										...
										//*argv[]	sta per argument vector, È un array di puntatori a caratteri, Ogni elemento di questo array (argv[0], argv[1], ecc.) contiene uno degli argomenti passati dalla riga di comando. argv[0] di solito contiene il percorso o il nome del programma eseguito.
{
    ...
    tempomedio_bubble_v1 /= numero_esperimenti;			//tempomedio_bubble_v1 /= numero_esperimenti;: Questa linea calcola il tempo di esecuzione medio dividendo il tempo totale accumulato per il numero di esperimenti. Il risultato è il tempo medio impiegato dall'algoritmo Selection Sort per ordinare il vettore v1

    cout << "Selection Sort - v1 (microseconds): " << tempomedio_bubble_v1 << endl;
    ...
    cout << "Selection Sort - v2 (microseconds): " << tempomedio_bubble_v2 << endl;
    ...
    cout << "Selection Sort - v3 (microseconds): " << tempomedio_bubble_v3 << endl;
    ...
    cout << "Insertion Sort - v1 (microseconds): " << timemedio_heap_v1 << endl;
    ...
    cout << "Insertion Sort - v2 (microseconds): " << timemedio_heap_v2 << endl;
    ...
    cout << "Insertion Sort - v3 (microseconds): " << timemedio_heap_v3 << endl;
